...
import AdminLegacyPointsPage from './pages/admin/AdminLegacyPointsPage.tsx'
  ...
  return (
    <Routes>
      ...
      <Route path="/" element={<ProtectedRoute><Layout /></ProtectedRoute>}>
        ...
        <Route path="admin/legacy-points" element={<AdminRoute><AdminLegacyPointsPage /></AdminRoute>} />
      </Route>
